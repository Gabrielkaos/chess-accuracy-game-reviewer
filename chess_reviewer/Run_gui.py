...
#TODO bug in replaying moves, sometimes displays wrong move cap and move recommended
#TODO the move_capper function takes accuracy and blunder history
...
goob_e = "engines/ChessEngine.exe"
...
def elo_reduction(depth):
    return 29.166666666667 * depth - 825
...
def main():
    ...
    engines_estimated_elo = 2800 # +100, -100
        ...
        for event in pygame.event.get():
            if event.type==pygame.QUIT:
                ...
                if event.key==pygame.K_r:
                    ...
                    except ValueError:analysis_depth = 20

                    #elo reduction TODO
                    engines_estimated_elo += elo_reduction(analysis_depth)

                    print()
                    fen_with_moves,phase_accuracy,eval_list,best_moves,accuracies,w_acc,b_acc = accuracy_full_game(game.game_positions,analysis_depth)
                    ...
                    for i in range(len(game.white_moves)):
                        ...
                        if len(black_cap_hist) > 0 and w_move_cap in ["best","great","brilliant"]:
                            if black_cap_hist[-1] == "blunder":w_move_cap= "great"

                        if w_move_cap == "blunder" and b_move_cap in ["best","great","brilliant"]:
                            b_move_cap = "great"
